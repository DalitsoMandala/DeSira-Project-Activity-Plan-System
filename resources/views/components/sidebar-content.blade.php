    ...
    <li x-data="{ open: true }">
        ...
        <ul x-show="open" x-collapse class="px-4 mt-2 space-y-1">
            ...
            <li x-data="{ open: false }">
                <div class="flex items-center justify-between px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700"
                    @click="open = !open">
                    <span class="text-sm font-medium"> <i class="mx-2 ri-plant-line"></i> Soybean </span>
                    <span class="transition duration-300 shrink-0" :class="{ '-rotate-180': open }">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
                ...
                <ul x-show="open" x-collapse class="px-4 mt-2 space-y-1">
                    ...
                    <li x-data="{ open: false }">
                        <div class="flex items-center justify-between px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700"
                            @click="open = !open">
                            <span class="text-sm font-medium"> On-Station </span>
                            <span class="transition duration-300 shrink-0" :class="{ '-rotate-180': open }">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
                    ...
                    <li x-data="{ open: false }">
                        <div class="flex items-center justify-between px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700"
                            @click="open = !open">
                            <span class="text-sm font-medium"> On-Farm </span>
                            <span class="transition duration-300 shrink-0" :class="{ '-rotate-180': open }">
                                <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 20 20"
                                    fill="currentColor">
                                    <path fill-rule="evenodd"
             ...
             <li x-data="{ open: false }">
                <div class="flex items-center justify-between px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700"
                    @click="open = !open">
                    <span class="text-sm font-medium"><i class="mx-2 ri-leaf-line"></i> Sweet Potato </span>
                    <span class="transition duration-300 shrink-0" :class="{ '-rotate-180': open }">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
               ...
               <li x-data="{ open: false }">
                <div class="flex items-center justify-between px-4 py-2 text-gray-500 rounded-lg cursor-pointer hover:bg-gray-100 hover:text-gray-700"
                    @click="open = !open">
                    <span class="text-sm font-medium"><i class="mx-2 ri-seedling-line"></i> Pigeon Pea </span>
                    <span class="transition duration-300 shrink-0" :class="{ '-rotate-180': open }">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
